...
class VoltBinAlgorithm(Algorithm):
    """Adjusted Data Algorithm"""

    def __init__(self, matrix=None, constant_file=None, inchannels=None,
            outchannels=None, data_type=None, location=None):
        Algorithm.__init__(self, inchannels=inchannels,
            outchannels=outchannels)
        # state variables
        self.constant_file = constant_file
        self.data_type = data_type
        self.location = location
        self.in_channels = inchannels
        self.out_channels = outchannels
        if (self.constant_file is not None):
            self.load_constant()
